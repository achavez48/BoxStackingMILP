...
tuple PermutationsCollectionType2{
...
{PermutationsCollectionType2} Omega2={<o,b>|o in Omega,b in o.box};
...
subject to{
	...
	//forall(o in Omega,i in B:i==card(o.box)){
	//	sum(oo in Omega,ii in B:card(oo.box)==card(o.box) && ii==item(oo.box,0))(x[oo][i])<=1;
	//}
